...
describe Ark::SevenZipCommandBuilder do
  ...
  describe '#unpack' do
    it 'generates the correct command' do
      ...
      expected_command = "\"C:\\Program Files\\7-zip\\7z.exe\" x \"release_file\" -so | \"C:\\Program Files\\7-zip\\7z.exe\" x -aoa -si -ttar -o\"temp_directory\" -uy && for /f %1 in ('dir /ad /b \"temp_directory\"') do c:\\Windows\\System32\\xcopy \"temp_directory\\%1\" \"path\" /s /e"
