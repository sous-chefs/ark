...
ark 'foo_tbz' do
  url "file://#{fixture_root}/foo.tbz"
  version '3'
end

ark 'foo_tgz' do
  url "file://#{fixture_root}/foo.tgz"
  version '3'
end

ark 'foo_txz' do
  url "file://#{fixture_root}/foo.txz"
  version '3'
end
...
ark 'foo_sub_tar' do
  url "file://#{fixture_root}/foo_sub.tar.gz"
  version '1'
  strip_components 2
end

ark 'foo_sub_zip' do
  url "file://#{fixture_root}/foo_sub.zip"
  version '2'
  strip_components 2
end
