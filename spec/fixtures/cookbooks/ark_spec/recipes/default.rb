...
ark 'test_dump' do
  url 'https://raw.githubusercontent.com/sous-chefs/ark/main/files/default/foo.zip'
...
ark 'foo_tbz' do
  url 'https://raw.githubusercontent.com/sous-chefs/ark/main/files/default/foo.tbz'
  version '3'
end

ark 'foo_tgz' do
  url 'https://raw.githubusercontent.com/sous-chefs/ark/main/files/default/foo.tgz'
  version '3'
end

ark 'foo_txz' do
  url 'https://raw.githubusercontent.com/sous-chefs/ark/main/files/default/foo.txz'
  version '3'
end
...
ark 'foo_sub_tar' do
  url 'https://raw.githubusercontent.com/sous-chefs/ark/main/files/default/foo_sub.tar.gz'
  version '1'
  strip_components 2
end

ark 'foo_sub_zip' do
  url 'https://raw.githubusercontent.com/sous-chefs/ark/main/files/default/foo_sub.zip'
  version '2'
  strip_components 2
end
